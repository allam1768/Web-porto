...
import { projectData } from '@/components/data'; // ✅ tambahin ini
    ...
    >
      <div className="relative h-80 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 text-white transform transition-transform duration-500">
          ...
          <p className={`text-gray-200 text-sm mb-4 transition-all duration-500 ${isHovered ? 'translate-y-0 opacity-100 max-h-40' : 'translate-y-4 opacity-0 max-h-0'}`}>
            {project.description}
          </p>
          ...
          <a 
            ...
            className={`inline-flex items-center gap-2 px-6 py-2 bg-cyan-500 hover:bg-cyan-600 text-white font-semibold rounded-full transition-all duration-500 ${isHovered ? 'translate-y-0 opacity-100' : 'translate-y-4 opacity-0'}`}
          >
            View Project
      ...
      <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <h2 className="text-5xl sm:text-7xl font-bold text-gray-800 mb-6">
            My <span className="text-cyan-500 relative">
              Projects
